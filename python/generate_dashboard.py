"""
Consumer360 - Dashboard Generator
Generates:
  1. Interactive HTML dashboard (open in any browser)
  2. Excel file ready for Power BI Desktop import
"""
...
def export_excel(df):
    ...
    print(f"Exporting Excel to {path}...")
